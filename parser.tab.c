...
{
       0,   114,   114,   118,   119,   123,   127,   130,   132,   136,
     137,   142,   152,   202,   225,   242,   247,   254,   265,   292,
     293,   294,   295,   296,   300,   301,   302
};
#endif
...
{
  "$end", "error", "$undefined", "INT", "CHAR", "FLOAT", "RETURN", "IF",
  "ELSE", "FOR", "WHILE", "SEMI", "COMMA", "ASSIGN", "LPAREN", "RPAREN",
  "LBRACE", "RBRACE", "ID", "NUM", "STRING", "UNSAFE_FUNC", "PRINTF",
  "LBRACK", "RBRACK", "PLUS", "MINUS", "MULT", "DIV", "$accept", "program",
  "functions", "function", "compound_stmt", "stmts", "stmt", "declaration",
...
{
      21,   -34,   -34,   -34,    16,    21,   -34,     9,   -34,   -34,
      14,    15,    13,   -34,   -34,    -3,    12,   -34,    -6,    18,
      19,   -34,    23,    17,    25,   -14,    20,    22,    24,   -34,
      26,   -34,    27,   -34,    -5,    28,    30,    29,    32,    34,
     -34,   -14,   -14,   -14,   -14,    33,    31,    36,    35,    37,
     -15,   -15,   -34,   -34,    38,   -34,    39,    42,   -34,    45,
      41,    47,   -34,    40,    46,    43,    54,    56,    49,   -34,
      52,    59,   -34
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,     0,     0,     7,     5,     0,     0,     6,     0,     0,
       0,     8,     0,     0,     0,     0,     0,     0,     0,     9,
      16,    15,    17,    23,     0,     0,     0,     0,     0,     0,
      11,     0,     0,     0,     0,     0,     0,     0,     0,     0,
      19,    20,    21,    22,     0,    12,     0,     0,    18,     0,
...
{
     -34,   -34,   -34,    66,   -34,   -34,   -34,   -34,   -33,    57
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     4,     5,     6,    14,    15,    21,    22,    34,     7
};
...
{
       1,     2,     3,    16,    32,    33,    40,    25,    50,    51,
      52,    53,    43,    44,    17,    18,     8,    26,    19,    20,
      41,    42,    43,    44,     1,     2,     3,    10,    11,    13,
      12,    24,    27,    28,    29,    30,    31,     0,     0,    35,
      36,    47,    55,     0,    37,    46,    54,     0,     0,    38,
      39,    48,    45,    49,    56,    61,    62,    59,    67,    57,
      63,    58,    60,    64,    65,    66,    68,    69,    70,    71,
      72,     9,    23
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     6,    18,    19,    11,    13,    41,    42,
      43,    44,    27,    28,    17,    18,     0,    23,    21,    22,
      25,    26,    27,    28,     3,     4,     5,    18,    14,    16,
      15,    19,    14,    14,    11,    18,    11,    -1,    -1,    19,
      18,    12,    11,    -1,    20,    15,    13,    -1,    -1,    23,
      23,    19,    24,    19,    18,    13,    11,    19,    15,    24,
      19,    24,    23,    16,    24,    19,    12,    11,    19,    17,
      11,     5,    15
};
...
{
       0,     3,     4,     5,    30,    31,    32,    38,     0,    32,
      18,    14,    15,    16,    33,    34,     6,    17,    18,    21,
      22,    35,    36,    38,    19,    13,    23,    14,    14,    11,
      18,    11,    18,    19,    37,    19,    18,    20,    23,    23,
      11,    25,    26,    27,    28,    24,    15,    12,    19,    19,
      37,    37,    37,    37,    13,    11,    18,    24,    24,    19,
      23,    13,    11,    19,    16,    24,    19,    15,    12,    11,
      19,    17,    11
};
...
#line 137 "parser.y"
                                                                                  {
        int size = atoi((yyvsp[-8].str));
        add_array((yyvsp[-10].str), get_type_from_token((yyvsp[-11].token_type)), size);
        free((yyvsp[-10].str)); free((yyvsp[-8].str)); free((yyvsp[-4].str)); free((yyvsp[-2].str));
      }
...
#line 142 "parser.y"
        ...
        if (lhs != -1) mark_initialized((yyvsp[-3].str));
        free((yyvsp[-3].str));
        free((yyvsp[-1].str));
      }
...
#line 152 "parser.y"
                                      {
    const char *unsafe_func = (yyvsp[-4].str);
...
#line 202 "parser.y"
                                           {
        int idx = find_var((yyvsp[-6].str));
        if (idx == -1) {
            printf("[⚠️ Warning][Line %d] Variable '%s' used without declaration.\n", line_num, (yyvsp[-6].str));
...
#line 225 "parser.y"
                                                                 {
    int idx = find_var((yyvsp[-5].str));
    if (idx == -1) {
        printf("[⚠️ Warning][Line %d] Variable '%s' used without declaration.\n", line_num, (yyvsp[-5].str));
        printf("[📘 Reference] Variable declaration before use: https://www.geeksforgeeks.org/how-to-avoid-compile-error-while-defining-variables/\n\n");
    } else if (!symbol_table[idx].is_array) {
        printf("[⚠️ Warning][Line %d] Variable '%s' is not declared as an array.\n", line_num, (yyvsp[-5].str));
        printf("[📘 Reference] Understanding arrays in C: https://www.tutorialspoint.com/what-is-out-of-bounds-index-in-an-array-c-language\n\n");
    } else {
        int index = atoi((yyvsp[-3].str));
        if (index >= symbol_table[idx].array_size) {
            printf("[❌ Error][Line %d] Array index out of bounds: %s[%d] (size: %d)\n", line_num, (yyvsp[-5].str), index, symbol_table[idx].array_size);
            printf("[📘 Reference] Array index bounds in C: https://www.tutorialspoint.com/what-is-out-of-bounds-index-in-an-array-c-language\n\n");
        }
    }
...
#line 247 "parser.y"
                        {
          add_var((yyvsp[0].str), get_type_from_token((yyvsp[-1].token_type)));
          free((yyvsp[0].str));
      }
...
#line 265 "parser.y"
        ...
        if (idx == -1) {
            ...
            if (!symbol_table[idx].is_array) {
                ...
                if (index >= symbol_table[idx].array_size) {
                    printf("[❌ Error][Line %d] Array index out of bounds: %s[%d] (size: %d)\n", line_num, (yyvsp[-3].str), index, symbol_table[idx].array_size);
                    printf("[📘 Reference] Array index bounds in C: https://www.tutorialspoint.com/what-is-out-of-bounds-index-in-an-array-c-language\n\n");
                }
            }
        }
...
#line 1633 "parser.tab.c"
  ...
  case 19:
#line 292 "parser.y"
                                 { (yyval.str) = NULL; /* check sub-expressions if needed */ }
...
#line 1669 "parser.tab.c"
  ...
  case 25:
#line 301 "parser.y"
            { (yyval.token_type) = CHAR; }
#line 1675 "parser.tab.c"
    break;

  case 26:
#line 302 "parser.y"
            { (yyval.token_type) = FLOAT; }
